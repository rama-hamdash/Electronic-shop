          ...
          <div class="row">
            ...
            <div class="col-md-12">
              <div class="owl-carousel owl-theme">
                <a href= "{{assets('assets/single-product.html')}}">
                  <div class="featured-item">
                    <img src="{{assets('assets/images/item-01.jpg')}}" alt="Item 1">
                ...
                <a href="{{assets('assets/single-product.html')}}">
                  <div class="featured-item">
                    <img src="{{assets('assets/images/item-02.jpg')}}" alt="Item 2">
                ...
                <a href="{{assets('assets/single-product.html')}}">
                  <div class="featured-item">
                    <img src="{{assets('assets/images/item-03.jpg')}}" alt="Item 3">
                ...
                <a href="{{assets('assets/single-product.html')}}">
                  <div class="featured-item">
                    <img src="{{assets('assets/images/item-04.jpg')}}" alt="Item 4">
                ...
                <a href="{{assets('assets/single-product.html')}}">
                  <div class="featured-item">
                    <img src="{{assets('assets/images/item-05.jpg')}}" alt="Item 5">
                    <h4>Morbi aliquet</h4>
                    <h6>$55.00</h6>
                  </div>
                </a>
                <a href="{{assets('assets/single-product.html')}}">
                  <div class="featured-item">
                    <img src="{{assets('assets/images/item-06.jpg')}}" alt="Item 6">
                    <h4>Urna ac diam</h4>
                    <h6>$65.00</h6>
                  </div>
                </a>
                <a href="{{assets('assets/single-product.html')}}">
                  <div class="featured-item">
                    <img src="{{assets('assets/images/item-04.jpg')}}" alt="Item 7">
                ...
                <a href="{{assets('assets/single-product.html')}}">
                  <div class="featured-item">
                    <img src="{{assets('assets/images/item-05.jpg')}}" alt="Item 8">
                ...
                <a href="{{assets('assets/single-product.html')}}">
                  <div class="featured-item">
                    <img src="{{assets('assets/images/item-06.jpg')}}" alt="Item 9">
                    <h4>Cras tempus</h4>
                    <h6>$95.00</h6>
                  </div>
                </a>
