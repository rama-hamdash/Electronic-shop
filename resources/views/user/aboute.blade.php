      ...
      <div class="row">
        ...
        <div class="col-md-6">
          <div class="right-content">
            ...
            <div class="share">
              <h6>Find us on: <span><a href="{{asset('assets/#')}}"><i class="fa fa-facebook"></i></a><a href="{{asset('assets/#')}}"><i class="fa fa-linkedin"></i></a><a href="{{asset('assets/#')}}"><i class="fa fa-twitter"></i></a></span></h6>
            </div>
          </div>
        </div>
      </div>
