          ...
          <div class="mb-3 p-2 col-3"><div class="input-group input-group-outline mb-2 inline">
            ...
            <table class="table ">
             ...
             <tr>
              ...
              <td>{{$product->price}}</td>
              <td><img src="{{asset('storage/'.$product->image_url)}}" width="50px" height="50px"></td>
               <td><a class="text-info" href="{{route('admin.products.show',[$product->id])}}"><i class="fas fa-eye"></i></a></td>
              <td > <a class="text-warning" href="{{route('admin.products.edit',[$product->id])}}"><i class="fas fa-edit"></i></a></td>
